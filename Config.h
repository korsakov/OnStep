...
#define SERIAL_C_BLUETOOTH_NAME  "KeenOne" // "On..", Bluetooth device name for ESP32.                                         Option
...
#define AXIS1_STEPS_PER_DEGREE    37709.33333 //  12800, n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_HOME_DEFAULT             90 //    90 (GEM) or 0 (for FORK or ALTAZM) This is the default home position at startup.

// AXIS2 DEC/ALT
// see https://onstep.groups.io/g/main/wiki/Configuration-Mount#AXIS2
#define AXIS2_STEPS_PER_DEGREE    37709.33333 //  12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS2_HOME_DEFAULT             90 //    90 (GEM) or 0 (for FORK or ALTAZM) This is the default home position at startup.
